...
import { EditalgorithmComponent } from './pages/editalgorithm/editalgorithm.component';
import { ViewalgorithmComponent } from './pages/viewalgorithm/viewalgorithm.component';
import { ViewcaseComponent } from './pages/viewcase/viewcase.component';
...
const routes: Routes = [
  ...
  { path:"editalgorithm/:id",component:EditalgorithmComponent, canActivate: [AuthGuard] },
  ...
  {path:'viewcase/:id',component:ViewcaseComponent, canActivate: [AuthGuard]},
  {path:'viewalgorithm/:id',component:ViewalgorithmComponent, canActivate: [AuthGuard]},
